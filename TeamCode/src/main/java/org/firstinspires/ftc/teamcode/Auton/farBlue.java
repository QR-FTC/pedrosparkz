...
public class farBlue {@Autonomous(name = "Example Auto", group = "Examples")
public class farRed extends OpMode {
    private Follower follower;
    private Timer pathTimer, actionTimer, opmodeTimer;
    private int pathState;
    private final Pose startPose = new Pose(56, 8,Math.toRadians(90)); // Start Pose of our robot.
    private final Pose scorePose = new Pose(57, 86, Math.toRadians(135)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
    private final Pose pickup1Pose = new Pose( 36,107, Math.toRadians(135)); // Highest (First Set) of Artifacts from the Spike Mark.
    private final Pose pickup2Pose = new Pose(35, 84, Math.toRadians(270)); // Middle (Second Set) of Artifacts from the Spike Mark.
    private final Pose pickup3Pose = new Pose(14, 84, Math.toRadians(270)); // Lowest (Third Set) of Artifacts from the Spike Mark.
    private final Pose pickup4Pose = new Pose(35, 60, Math.toRadians(270)); // Lowest (Third Set) of Artifacts from the Spike Mark.
    private final Pose pickup5Pose = new Pose(14, 60, Math.toRadians(180));
    private final Pose pickup6Pose = new Pose(35, 35, Math.toRadians(270));
    private final Pose pickup7Pose = new Pose(13, 35, Math.toRadians(180));


    private Path scorePreload;
    private PathChain middleBlue,shooting, firstThree, ftcollected, secondThree, stcollected, lastThree, ltcollected;
    ...
    scorePreload.setConstantInterpolation(startPose.getHeading()); */
        ...
        middleBlue = follower.pathBuilder()

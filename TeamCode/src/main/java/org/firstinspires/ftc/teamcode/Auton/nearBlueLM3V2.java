...
public class nearBlueLM3V2 extends OpMode {
    ...
    PathChain scorePreload, endingposition,gomiddleset, collectmiddleset, openingate, shootmiddleset, arriveset1, collectset1, shootset1, arriveset3, collectset3, scoringset3;
...
//                /* This is our grabPickup3 PathChain. We are using a single path with a BezierLine, which is a straight line. */
        ...
        scoringset3 = follower.pathBuilder()
                ...
                .build();
        endingposition = follower.pathBuilder()
                .addPath(new BezierLine(scorePose, endingpos))
                .setLinearHeadingInterpolation(scorePose.getHeading(), endingpos.getHeading())
                .build();
...
//                    }
            ...
            */
                ...
                if (!follower.isBusy()) {
                    follower.followPath(endingposition, true);
                    setPathState(-200);
                    intake.setPower(0.0);
                    RPM = 0;
                    /* Score Preload */

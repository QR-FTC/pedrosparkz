...
@Autonomous(name = "farblue1stset", group = "Examples")
public class farblue1stset extends OpMode {
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            case 0: {
                ...
                RPM=shooterCalculatons.autoshoot(follower.getPose().getX(),follower.getPose().getY(),false)-50;
                setPathState(1);
            }
//            case 0: {
//                follower.followPath(scorePreload);
            ...
            case 15:
            {
                if(!follower.isBusy()) {
                    ...
                    if (1.0 <= catTimer.getElapsedTimeSeconds() && catTimer.getElapsedTimeSeconds() < 4.25){
                        intake.setPower(0.0);
                        RPM=shooterCalculatons.autoshoot(follower.getPose().getX(),follower.getPose().getY(),false) +40;
                    }

...
@Autonomous(name = "nearBlues", group = "Examples")
public class nearBlueLM3 extends OpMode {
    ...
    private final Pose arrivingtomiddleballs = new Pose (48,60, Math.toRadians(180));
    private final Pose collectingmiddleballs = new Pose(19, 60, Math.toRadians(180)); // Highest (First Set) of Artifacts from the Spike Mark.
    private final Pose opengate = new Pose(15, 72, Math.toRadians(180)); // Middle (Second Set) of Artifacts from the Spike Mark.
    private final Pose arrivingtoset1 = new Pose(46, 84, Math.toRadians(180));
    private final Pose collectingset1 = new Pose(19, 84, Math.toRadians(180));

    private final Pose arrivingset3 = new Pose(46, 36, Math.toRadians(180));
    private final Pose collectingset3 = new Pose(19, 36, Math.toRadians(180));

...
public class farReds extends OpMode {
    ...
    private final Pose getScorePose = new Pose(86, 80,Math.toRadians(45));
    ...
    scorePreload.setConstantInterpolation(startPose.getHeading()); */
        ...
        grabPickup1 = follower.pathBuilder()
                .addPath(new BezierLine(scorePose, getScorePose))
                .setLinearHeadingInterpolation(scorePose.getHeading(), getScorePose.getHeading())
                .build();
